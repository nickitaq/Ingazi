...
$result=mysqli_query($conn, "select * from tbl_users   order by id desc"); 
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <?php if($row['email_verify'] == '1'){ ?>
                                            <a  href="" style="color:green" >Verified </a>
                                        <?php } else{ ?>
                                            <a  href="" style="color:red" >Not Verified </a>
                                        <?php } ?>
                                    </th>
